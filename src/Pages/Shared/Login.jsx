...
const Login = () => {
  ...
  return (
    <div className="mx-auto my-10 w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 text-gray-100">
      ...
      >
        ...
        <div className="space-y-1 text-sm">
          ...
          <input
            ...
            className="w-full px-4 border py-3 rounded-md border-gray-700 bg-gray-900 text-gray-100 focus:border-violet-400"
          />
